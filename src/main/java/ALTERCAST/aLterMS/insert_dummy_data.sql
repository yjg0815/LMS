...
values
    (now(), now(), 'Term Project가 업로드 되어 있습니다.
...
VALUES
    (now(), now(), '2024-03-15 11:59', '2024-03-03 00:00', '1', 12);

insert into assignment(created_at, updated_at, deadline, description, point, title, sec_id)
VALUES
    (now(), now(), '2024-06-03 21:00', '첨부 문서를 참조하기 바랍니다.', 30, 'Term Project', 12);

insert into notification (created_at, updated_at, description, title, section_id)
values
    (now(), now(), '기말고사 일정과 범위는 다음과 같습니다.
...
insert into learning(created_at, updated_at, end, start, week_num, section_id)
VALUES
    (now(), now(), '2024-03-21 11:59', '2024-03-10 00:00', '2', 12);
